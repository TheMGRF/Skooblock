package games.indigo.skooblock.island.permissions;

public class IslandVisitorPermissionSet {

    private boolean ALLOW_BLOCK_PLACING;
    private boolean ALLOW_BLOCK_BREAKING;
    private boolean ALLOW_CONTAINER_ACCESS;
    private boolean ALLOW_WORKBENCH_ACCESS;
    private boolean ALLOW_FURNACE_ACCESS;
    private boolean ALLOW_ENCHANTING;
    private boolean ALLOW_ANVIL_USE;
    private boolean ALLOW_ARMOUR_STAND_USE;
    private boolean ALLOW_BEACON_USE;
    private boolean ALLOW_JUKEBOX_USE;
    private boolean ALLOW_BED_USE;
    private boolean ALLOW_POTION_BREWING;
    private boolean ALLOW_ANIMAL_BREADING;
    private boolean ALLOW_BUCKET_USE;
    private boolean ALLOW_DOOR_USE;
    private boolean ALLOW_GATE_USE;
    private boolean ALLOW_CROP_TRAMPLE;
    private boolean ALLOW_THROWING_EGGS;
    private boolean ALLOW_THROWING_EPEARLS;
    private boolean ALLOW_VEHICLE_USE;
    private boolean ALLOW_HURT_PEACEFUL;
    private boolean ALLOW_HURT_HOSTILE;
    private boolean ALLOW_LEASHING;
    private boolean ALLOW_BUTTON_USE;
    private boolean ALLOW_LEVER_USE;
    private boolean ALLOW_PRESSUREPLATE_USE;
    private boolean ALLOW_PVP;
    private boolean ALLOW_COW_MILKING;
    private boolean ALLOW_SHEEP_SHEARING;
    private boolean ALLOW_VILLAGER_TRADING;
    private boolean ALLOW_ITEM_DROPPING;
    private boolean ALLOW_ITEM_PICKUP;
    private boolean ALLOW_KEEP_EXP_ON_DEATH;
    private boolean ALLOW_KEEP_ITEMS_ON_DEATH;
