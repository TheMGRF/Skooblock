package me.themgrf.skooblock.commands;
...
import me.themgrf.skooblock.guis.*;
                    ...
                    if (args[0].equalsIgnoreCase("help")) {
                        ...
                        if (skooBlock.getIslandManager().playerHasIsland(player.getUniqueId().toString())) {
                            ...
                            if (cooldown == null || cooldown.isExpired()) {
                                player.setMetadata("resettingIsland", new FixedMetadataValue(main, true));
                                IslandTypeSelector.open(player);
                            } else {
                        ...
                        if (skooBlock.getIslandManager().playerHasIsland(player.getUniqueId().toString())) {
                            ...
                            if (cooldown == null || cooldown.isExpired()) {
                                player.setMetadata("islandBiome", new FixedMetadataValue(main, true));
                                BiomeSelector.open(player);
                            } else {
